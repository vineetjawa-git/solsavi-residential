        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://x.com/Solsavi_avc" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-10 h-10 rounded-lg bg-background/10 hover:bg-accent flex items-center justify-center transition-colors">
